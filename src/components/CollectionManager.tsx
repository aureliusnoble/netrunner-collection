                    ...
                    {sets.map((cs) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1.5 sm:gap-2 ml-3 sm:ml-4">
                            <button
                              onClick={() => {
                                if (owned > 0) onAddProduct(cs.id, owned - 1);
                              }}
                              disabled={owned === 0}
                              className="w-9 h-9 sm:w-8 sm:h-8 rounded-lg bg-white/10 hover:bg-white/20 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
                            >
                              <Minus size={16} />
                            </button>
                            ...
                            <button
                              ...
                              className="w-9 h-9 sm:w-8 sm:h-8 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                            >
                              <Plus size={16} />
                            </button>
                            {owned > 0 && (
                              <button
                                ...
                                className="ml-0.5 p-1.5 text-red-400/70 hover:text-red-300 transition-colors"
                              >
                                <X size={14} />
                              </button>
                            )}
              ...
              <div className="max-h-60 overflow-y-auto space-y-1 bg-black/20 rounded-lg p-2">
                {manualSearchResults.map((card) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2.5 sm:py-2 text-sm rounded hover:bg-white/10 transition-colors"
                  >
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-1.5 text-red-400/70 hover:text-red-300 ml-1 transition-colors"
                    >
                      <X size={14} />
                    </button>
                  </div>
